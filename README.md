# Heatmap-Code
1. Code for making a heatmap with RNA seq data
2. Code taken with slight edits from: https://github.com/mousepixels/sanbomics_scripts/blob/main/PyDeseq2_DE_tutorial.ipynb
...
5. Original files, for those who want to start at the beginning and create these heatmaps, are all in the RawSeqCounts folder. Those were combined into rawcountdata, and then run through CreatingCleanRNADataset.ipynb to make Droppednamesthreshrawcounts.csv. Gene names were manually deleted in this file to make it work with DeSeq2. 
